...
is_('пусто = все группы, разрешённые сайтом', Token::groups(['TOOLS' => '']), null);
is_('поля нет вовсе = все',                   Token::groups([]), null);
...
// Пустой список — «ни одной группы»: снятые в админке галки должны закрывать
// доступ, а не молча возвращать полный набор.
is_('пустой json-список — это НЕ «все»', Token::groups(['TOOLS' => '[]']), []);
