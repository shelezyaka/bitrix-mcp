...
class Sql
{
	...
	const DENY = [
		...
		// Настройки платёжных систем и служб доставки — это доступы к эквайрингу
		// и к API перевозчиков. Названия для отчётов даёт sale_directories.
		'b_sale_bizval'            => 'логины и ключи платёжных систем',
		'b_sale_cashbox'           => 'доступы к кассам и ОФД',
		'b_sale_pay_system_action' => 'настройки платёжных систем',
		'b_sale_delivery_srv'      => 'настройки служб доставки',
	];
